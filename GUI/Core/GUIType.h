...
*
*              锟紺/GUI is protected by international copyright laws. Knowledge of the
...
/* PROP: Proportional fonts FLASH */
DECLARE_FONT(PROPFLASH);
#define GUI_FONTTYPE_PROP_FLASH  \
  GUIPROPFLASH_DispChar,         \
	GUIPROPFLASH_GetCharDistX,         \
	GUIPROPFLASH_GetFontInfo,          \
	GUIPROPFLASH_IsInFont,             \
  &GUI_ENC_APIList_SJIS
