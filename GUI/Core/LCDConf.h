...
#define LCD_XSIZE      (176)   /* X-resolution of LCD, Logical coor. */
#define LCD_YSIZE      (176)   /* Y-resolution of LCD, Logical coor. */
#define LCD_BITSPERPIXEL (8)
//#define LCD_BITSPERPIXEL (16)  //16Bpp
 
#define LCD_CONTROLLER 1374 //  /*lcd控制器的具体型号*/

#define LCD_FIXEDPALETTE  (332)   /*RGB颜色位数*/
